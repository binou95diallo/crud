...
// Returns the private 'App\Repository\BankAccountRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BankAccountRepository.php';

return $this->privates['App\\Repository\\BankAccountRepository'] = new \App\Repository\BankAccountRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
