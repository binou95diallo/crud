...
// Returns the private 'App\Repository\UsersPartenaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsersPartenaireRepository.php';

return $this->privates['App\\Repository\\UsersPartenaireRepository'] = new \App\Repository\UsersPartenaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
