...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdminPartenaireController' => 'getAdminPartenaireControllerService.php',
            'App\\Controller\\AdminSystemeController' => 'getAdminSystemeControllerService.php',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AdminPartenaireRepository' => ['privates', 'App\\Repository\\AdminPartenaireRepository', 'getAdminPartenaireRepositoryService.php', true],
            'App\\Repository\\AdminSystemeRepository' => ['privates', 'App\\Repository\\AdminSystemeRepository', 'getAdminSystemeRepositoryService.php', true],
            'App\\Repository\\BankAccountRepository' => ['privates', 'App\\Repository\\BankAccountRepository', 'getBankAccountRepositoryService.php', true],
            'App\\Repository\\PartenaireRepository' => ['privates', 'App\\Repository\\PartenaireRepository', 'getPartenaireRepositoryService.php', true],
            'App\\Repository\\UsersPartenaireRepository' => ['privates', 'App\\Repository\\UsersPartenaireRepository', 'getUsersPartenaireRepositoryService.php', true],
        ], [
            'App\\Repository\\AdminPartenaireRepository' => '?',
            'App\\Repository\\AdminSystemeRepository' => '?',
            'App\\Repository\\BankAccountRepository' => '?',
            'App\\Repository\\PartenaireRepository' => '?',
            'App\\Repository\\UsersPartenaireRepository' => '?',
        ])));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_bd910343553dbeb604913671e77e12ee28ba93bf6befce7358f70ae81d11ac4f');
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WSqZPunvCT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xbyXmtfp6r', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ci9GY5Hl+G', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IHSwMNnkz3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MOIcNczXeT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
